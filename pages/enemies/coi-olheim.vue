<template>
  <Enemy
    ...
    :skills="[
      {
        name: 'Extreme Spinning Chop',
        description:
          'Olheim swings his two blades in a high-speed spinning attack against an enemy',
      },
      {
        name: 'Quick Chop',
        description:
      ...
      },
      {
        ...
        description: `Olheim's blood boils, increasing his ATK.`,
      },
    ]"
  />
</template>
