<template>
  <Enemy
    ...
    :intel="[
      'It could be said these humanoid statue-like AGI Mechas are a distinguishing feature of the landscape of Stellaris Academy. Over the course of their updated iterations, this is now the most widely-used and applicable type.',
      ...
      `It's said that when this type of AGI Mecha was first to put to use, they frightened many timid teachers and students, for a time becoming to subject of many a strange tale circulating around Stellaris Academy.`,
    ]"
    :skills="[
      {
        name: 'H-Halt !',
