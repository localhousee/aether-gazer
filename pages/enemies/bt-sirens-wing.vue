<template>
  <Enemy
    name="BT <Siren's Wing>"
    image="bt-sirens-wing.jpg"
    type="Visbanes"
    risk="III"
    description="The disguise of a Behemoth Type Visbane that appears near the Peripheral Sea, the pure white sea demoness. Those bewitched by its appearance are completely unaware of the trap they've fallen into."
    :intel="[
    ...
    :skills="[
      {
        name: 'Dream Rush',
        description:
          'Siren summons numerous water projectiles and sends them hurtling toward the enemy ahead.',
      },
      {
        name: 'Sea-Piercing Torrent',
        description:
          'Siren stirs up winds and waves summoning two rays to attack the seaborne enemy.',
      },
    ]"
  />
</template>
