    ...
    :skills="[
      {
        name: 'Beam Pulse',
        description:
          'Gathers energy, then fires a high-energy pulse at enemies ahead.',
      },
      {
        name: 'Silent Darkness',
        description:
          'Unleashes a circular energy field around it that slows enemies within it.',
      },
    ]"
  />
</template>
