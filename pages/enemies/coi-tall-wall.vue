  ...
  <Enemy
    ...
    :skills="[
      ...
      },
      {
        name: 'Clean Sweeper',
        description:
          'High Wall chucks out a bomb, dealing damage to enemies ahead.',
      },
      {
        name: 'Line Breaker',
        description:
          'High Wall enters Sweep Mode and sprays the left, right, and front with the bullets.',
      },
    ]"
  />
</template>
